    ...
    <div>
      <footer className="footer p-10 bg-neutral text-neutral-content">
        <aside>
          ...
          <p>
            <span className='font-bold text-2xl'>R.A.H Art & Craft</span><br />
        ...
        <p className="text-center mt-6">&copy; {new Date().getFullYear()} R.A.H Art & Craft Store. All rights reserved.
        </p>
      </footer>
    </div>
  );
